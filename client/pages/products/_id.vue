        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="leftCol">
              ...
              <div clas="imgBlock">
                <div class="eBooksimg">
                  <img src="/img/turbo.png" class="img-fluid" />
                </div>
              </div>
            ...
            <div class="centerCol">
              ...
              <div class="titleDiv">
                <h1 class="productTitle">
                  <span class="largeTitle">Turbo Charger</span>
                  <span class="smallTitle">BMW</span>
                </h1>
              </div>
              ...
              <div class="mediaMatrix">
                <div class="formats">
                  <a href="#" class="link-expander">
                    >
                    <span class="tmmShowPrompt">See associated products</span>
                  </a>
                  <ul>
                    <!-- Kindle -->
              ...
              <div class="bookDescription">
                <div class="bookDescriptionInner">This part works for BMW 1 series and 3 series</div>
              </div>
            ...
            <div class="combinedBuyBox">
              <div class="buyBox">
                ...
                <div class="a-section a-spacing-small">
                  ...
                  <div class="a-section a-spacing-mini">Ships from Nairobi</div>
                </div>
                ...
                <span class="a-declarative">
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      ...
                      <span class="a-size-small">Deliver to Kisumu</span>
                    </div>
                  </a>
                </span>
                <br />
